            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <form role="form" method="POST" action="{{ route('article.update', $article->slug) }}"
                                ...
                                <div class="col-md-offset-3 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="title" id="title"
                                               placeholder="article title" value="@if(old('title')){{ old('title') }}@else{{ $article->title }}@endif">
                                    </div>
                            ...
                            <div class="box box-info">
                                ...
                                <div class="box-body pad">
                                    ...
                                    <textarea id="editor1" name="content" rows="8"
                                              cols="80">@if(old('content')){{ old('content') }}@else{{ $article->content }}@endif</textarea>
